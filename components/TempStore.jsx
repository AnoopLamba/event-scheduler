...
const meetings = [
  {
    ...
    startDatetime: "2024-01-15T13:00",
...
export default function TempStore() {
  ...
  // This will return array of meetings for the selected day
  let selectedDayMeetings = reminders.filter((meeting) =>
            ...
            <section className="mt-12 md:mt-0 md:pl-14">
              ...
              <ol className="mt-4 space-y-1 text-sm leading-6 text-gray-500">
                {selectedDayMeetings.length > 0 ? (
                  selectedDayMeetings.map((remainder) => (
                    <Meeting meeting={remainder} key={remainder.id} />
                  ))
                ) : (
